  ...
  const login = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        // Use sub + email to construct a minimal id-token-like payload and
        // call the backend Google endpoint with the access token directly.
        // The backend calls tokeninfo which accepts access tokens too.
